          ...
          <ScrollReveal delay={0.05}>
            <div className="mt-5 flex items-start gap-4 sm:gap-5">
              {!node.image && (
                <ProductIcon
                  type={node.icon}
                  className="h-12 w-12 shrink-0 text-brass-400 sm:h-16 sm:w-16"
                />
              )}
              <div>
          ...
          <div className="wrap grid grid-cols-1 gap-10 lg:grid-cols-12">
            <ScrollReveal className="lg:col-span-5">
              <div className="spec-card mx-auto max-w-sm lg:max-w-none">
                ...
                <div className="flex aspect-square items-center justify-center bg-paper p-10">
                  {node.image ? (
                    <Image
                      src={node.image}
                      alt={node.name}
                    ...
                    <ProductIcon type={node.icon} className="h-32 w-32 text-graphite-300 sm:h-40 sm:w-40" />
                  )}
                </div>
              </div>
            </ScrollReveal>
