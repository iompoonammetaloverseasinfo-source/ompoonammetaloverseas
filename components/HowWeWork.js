...
// rather than generic stock copy.
const steps = [
  {
    icon: ClipboardList,
    step: "01",
    title: "Enquiry",
    body: "Share the grade, form, size and quantity — by call, WhatsApp or the form on this site. Most enquiries get a stock and price confirmation the same working day.",
  },
  {
    icon: ScanSearch,
    step: "02",
    title: "Grade Verification",
    body: "Material is checked against its mill certificate before it's confirmed against your order — the same verification step our ISO 9001:2015 audit reviews every cycle.",
  },
  {
    icon: PackageCheck,
    step: "03",
    title: "Dispatch",
    body: "\u201COn-time delivery\u201D isn't just a promise here — it's a standing quality objective we're formally measured against at every management review.",
  },
  {
    icon: Truck,
    step: "04",
    title: "After Delivery",
    body: "Post-delivery support stays open for grade queries, documentation, or the next order — most of our business is repeat customers.",
  },
];
